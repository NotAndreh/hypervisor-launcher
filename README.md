...
A lightweight launcher that automates loading a hypervisor driver (Intel or AMD), launching a game under it, and cleaning up afterward. It handles DSE (Driver Signature Enforcement) bypass via EfiGuard, and loads the appropriate driver based on your CPU.
